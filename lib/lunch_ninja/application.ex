defmodule LunchNinja.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: LunchNinja.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    LunchNinjaWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
